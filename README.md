# AWS-AI-Cloud-Security-Scanner
Built a Python CLI tool that scans Terraform and IAM policy files for real-world security anti-patterns like wildcard permissions, public access, and missing encryption.
